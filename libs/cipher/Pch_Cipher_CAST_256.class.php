<?php
/**
 * Cast_256 algorithm class implementing the Cipher interface enryption.
 *
 ...
 *
 * @package    phpChain
 * @version    $Id: Pch_Cipher_CAST_256.class.php,v 1.5 2006/01/03 07:33:49 gogogadgetscott Exp $
 ...
 * @author  Scott Greenberg <me@gogogadgetscott.com>
 */
class Pch_Cipher_Cast_256 extends Pch_Cipher
{ // BEGIN class Pch_Cipher_Cast_256
 ...
 * Constructor.
 *
 * @return obj     New instance of Pch_Cipher_Cast_256 class
 * @access private
 * @todo Setup error handling in recieving (Pch_Main) class.
 */
function Pch_Cipher_Cast_256()
{
    $this->_iv_size = 32;
...
{
    return $this->_encrypt(MCRYPT_CAST_256, $data, $iv, $key);
}
...
{
    return $this->_decrypt(MCRYPT_CAST_256, $data, $iv, $key);
}

} // END class Pch_Cipher_Cast_256
