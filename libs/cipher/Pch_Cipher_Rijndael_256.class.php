<?php
/**
 * Rijndael_256 algorithm class implementing the Cipher interface enryption.
 *
 ...
 *
 * @package    phpChain
 * @version    $Id: Pch_Cipher_Rijndael_256.class.php,v 1.6 2006/01/03 07:33:49 gogogadgetscott Exp $
 ...
 * @author  Scott Greenberg <me@gogogadgetscott.com>
 */
class Pch_Cipher_Rijndael_256 extends Pch_Cipher
{ // BEGIN class Pch_Cipher_Rijndael_256
 ...
 * Constructor.
 *
 * @return obj     New instance of Pch_Cipher_Rijndael_256 class
 * @access private
 * @todo Setup error handling in recieving (Pch_Main) class.
 */
function Pch_Cipher_Rijndael_256()
{
    $this->_iv_size = 32;
 ...
 * @access private
 */
function _Pch_Cipher_Rijndael_256()
{
}
...
{
    return $this->_encrypt(MCRYPT_RIJNDAEL_256, $data, $iv, $key);
}
...
{
    return $this->_decrypt(MCRYPT_RIJNDAEL_256, $data, $iv, $key);
}

} // END class Pch_Cipher_Rijndael_256
