...
{* $Id: header.tpl,v 1.1 2006/01/31 01:50:13 gogogadgetscott Exp $ *}
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$urlTemplate}column.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="{$urlTheme}narrow.css" media="screen" />
</head>
<body>
